...
import dev.benica.infinite_longbox.database.models.Appearance
...
import dev.benica.infinite_longbox.database.models.CreditX
import dev.benica.infinite_longbox.database.models.ExCredit
import dev.benica.infinite_longbox.database.models.Issue
import dev.benica.infinite_longbox.database.models.NameDetail
...
class Expander private constructor(webservice: Webservice, prefs: SharedPreferences) : Updater(
    ...
    fun expandCharacterAsync(characters: List<dev.benica.infinite_longbox.database.models.Character>) =
